...
namespace NPEG.Tests
{
    ...
    public class CompositeVisitorTests
    {
        ...
        public void CompositeVisitor_RecursiveParentheses()
        {
            ...
            NpegParserVisitor visitor = new NpegParserVisitor(new StringInputIterator(input));
            ROOT.Accept(visitor);
            ...
            var LTENCLOSED = new RecursionCreate("RECURSIONLTENCLOSED",
                         new PrioritizedChoice(DIGITS,
                            new CapturingGroup("LTENCLOSED",
                                new Sequence(
                                    new Literal() { MatchText = "<" },
                                    new RecursionCall("RECURSIONLTENCLOSED")
                                ).Sequence(new Literal() { MatchText = ">" })
                            )
                         )
                     );
        ...
        {
            var newline = new PrioritizedChoice(
                        new Literal() { MatchText = "\r\n" },   // windows
            ...
            var backreference = new CapturingGroup("DynamicBackReferencing",
                        new Sequence(
                           ...
                           new Sequence(new ZeroOrMore(whitespace), label).Sequence(new ZeroOrMore(whitespace))
                        )
                        .Sequence(
                            new Optional(
                                new Sequence(
            ...
            var root = new CapturingGroup("Test",
                        new NonTerminals.Sequence(
                            backreference,
                            new NonTerminals.NotPredicate(new Terminals.AnyCharacter())
                        )
                       );
        ...
        public void CompositeVisitor_CapturingGroup_SandBoxTest_PriorityChoice2()
        {
            ...
            NpegParserVisitor visitor = new NpegParserVisitor(
        ...
        public void CompositeVisitor_CapturingGroup_SandBoxTest_PriorityChoice3()
        {
            ...
            var suffix = new PrioritizedChoice(
        ...
        public void CompositeVisitor_Recursiveness()
        {
            ...
            var expression = new CapturingGroup("Root", new RecursionCreate("Expression", new PrioritizedChoice(prioritizedchoice, sequence)));
