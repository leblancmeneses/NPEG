...
namespace NPEG.GrammarInterpreter
{
    ...
    {
        static private AExpression mSpace()
        {
            return new CharacterClass() { ClassExpression = "[ \t]" };
        }

        static private AExpression mNewLine()
        {
        ...
        static private AExpression mComment()
        {
            // Single Line Comment
        ...
        static private AExpression mWhiteSpace()
        {
            return new PrioritizedChoice(
        ...
        static private AExpression mHex()
        {
            return new Sequence(
        ...
        static private AExpression mBinary()
        {
            return new Sequence(
                        new Optional(new Literal() { MatchText = "0" }),
        ...
        static private AExpression mLabel()
        {
        ...
        static private AExpression mAnyCharacter()
        {
            return new CapturingGroup("AnyCharacter", new Literal() { MatchText = "." });
        }

        static private AExpression mCharacterClass()
        {
        ...
        static private AExpression mCodePoint()
        {
        ...
        static private AExpression mDynamicBackReference()
        {
            return new CapturingGroup("DynamicBackReferencing",
                        new Sequence(
                           new Literal() { MatchText = @"\k<" },
                           new Sequence(new ZeroOrMore(mWhiteSpace()), mLabel()).Sequence(new ZeroOrMore(mWhiteSpace()))
                        )
                        .Sequence(
                            new Optional(
                                new Sequence(
        ...
        static private AExpression mFATAL()
        {
        ...
        static private AExpression mWARN()
        {
        ...
        static private AExpression mLiteral()
        {
        ...
        static private AExpression mRecursionCall()
        {
            return new CapturingGroup("RecursionCall", mLabel());
        }


        static private AExpression mCapturingGroup()
        {
        ...
        static private AExpression mTerminalReference()
        {
            AExpression CG_ReplacementNode = new CapturingGroup("ReplacementNode", new Literal() { MatchText = @"\rn" });
            AExpression CG_ReplaceBySingleChild = new CapturingGroup("ReplaceBySingleChild", new Literal() { MatchText = @"\rsc" });
        ...
        static private AExpression mGroup()
        {
        ...
        static private AExpression mTerminal()
        {
            return new PrioritizedChoice(
                    mAnyCharacter(),
                    mCharacterClass()
        ...
        static private AExpression mPrefix()
        {
        ...
        static private AExpression mSuffix()
        {
                                    ...
                                    new Sequence(
                                        ...
                                        new PrioritizedChoice(
                                            ...
                                            new CapturingGroup("BETWEEN",
                                                new Sequence(
                                                    new CapturingGroup("Min", new OneOrMore(new CharacterClass() { ClassExpression = "[0-9]" })).Sequence(new ZeroOrMore(mSpace())),
                                                    new Literal() { MatchText = "," }
                                                )
                                                .Sequence(
                                                    new Sequence(new ZeroOrMore(mSpace()), new CapturingGroup("Max", new OneOrMore(new CharacterClass() { ClassExpression = "[0-9]" })))
                                                )
                                            )
                                            ,
                                            //{,max}
                                        ...
                                        (
                                            ...
                                            new CapturingGroup("ATLEAST",
                                                new Sequence(
                                                    new Sequence(new ZeroOrMore(mSpace()), new CapturingGroup("Min", new OneOrMore(new CharacterClass() { ClassExpression = "[0-9]" }))).Sequence(new ZeroOrMore(mSpace()))
                                                    ,
                                                    new Literal() { MatchText = "," }
                                                )
                                            )
                                        ...
                                        .Or
                                        (
                                            new CapturingGroup("EXACT", new OneOrMore(new CharacterClass() { ClassExpression = "[0-9]" }))
                                        )
                                    )
                                    .Sequence(
                                        new ZeroOrMore(mSpace())
        ...
        static private AExpression mExpression()
        {
            return new PrioritizedChoice(
        ...
        static private AExpression mSequence()
        {
        ...
        static private AExpression mPrioritizedChoice()
        {
        ...
        static private AExpression mExpressionRoot()
        {
        ...
        static private AExpression mStatement()
        {
            return new CapturingGroup(
                        "Statement",
                        new Sequence(
        ...
        private class PeGrammarAstNodeFactory : IAstNodeFactory
        {
            ...
            public IAstNodeReplacement Create(AstNode original)
            {
                ...
                throw new ArgumentOutOfRangeException(String.Format("PeGrammarAstNodeFactory does not define replacement node for: {0}", original.Token.Name));
            }

            #endregion
        }

        static public AExpression Load(String rules)
        {
            ...
            var visitor = new NpegParserVisitor(new StringInputIterator(Encoding.ASCII.GetBytes(rules)), new PeGrammarAstNodeFactory());
            ...
            throw new ApplicationExceptions.InvalidRuleException();
        }
    }
}
