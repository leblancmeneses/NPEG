...
namespace LanguageWorkbench.Algorithms.LanguageWriters
{
	public class JavaWriter : WriterBase
	{
		...
		public JavaWriter(String grammarName, String grammarInput, ZipPackage zipPackage)
		{
			_grammarName = grammarName;
			_grammarInput = grammarInput;
			_packagename = "LanguageWorkbench.Parsers".ToLower();
		...
		public override void Write()
		{
			...
			var bytes = Encoding.UTF8.GetBytes(src.ToString());
			var memoryStream = new MemoryStream();
			memoryStream.Write(bytes, 0, bytes.Length);
			memoryStream.Seek(0, SeekOrigin.Begin);
			_zipPackage.AddStream(memoryStream, String.Format("{0}.java", _grammarName));
		}
