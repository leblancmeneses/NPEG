...
public class OneOrMoreNonterminalTest extends TestCase {
	...
	public boolean bad() throws ParsingFatalTerminalException, InfiniteLoopException, IOException {
	    return oneOrMore(new _InfiniteLoopExpression(), "");
	}

	public boolean isMatch() throws ParsingFatalTerminalException, InfiniteLoopException, IOException {
	    return oneOrMore(new _expression(), "");
	}

	public _OneTest(InputIterator iterator) {
	    super(iterator, null);
	}
    }
    ...
    public OneOrMoreNonterminalTest() {
	super();
    }

    public static void main(String[] argv) {
	junit.textui.TestRunner.run(OneOrMoreNonterminalTest.class);
	System.exit(0);
    }
}